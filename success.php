...
<head>
    ...
    <title> Success | Kancaroo Car Carriers </title>
    <meta name="description" content="Thank you for your Response.">
    <meta property="og:locale" content="en_US">
    <meta property="og:title" content=" Success | Kancaroo Car Carriers">
    <meta property="og:description" content="Thank you for your Response.">
    <meta property="og:url" content="http://kancaroo.com/success">
    ...
    <script>
        gtag('event', 'conversion', {
            'send_to': 'AW-16517612478/ZlmLCLTur6MZEL6Hm8Q9'
        });
    </script>
</head>
...
<body>
    ...
    <div class="container-fluid success-banner p-0">
        ...
        <div class="container success-container position-relative">
            <div class="card p-md-5">
                <img src="assets/images/green-tick-circle-outline.png" width="58" height="58" loading="lazy" class="m-auto" alt="Success">
                <div class="card-body text-center">
                    <p class="card-title green subHead pb-3">Thank you for reaching out to us! <br> Our team will contact you shortly.</p>
                    <a href="./" class="card-link btn btn-danger submit-btn">Home</a>
                </div>
            </div>
        </div>
    </div>
